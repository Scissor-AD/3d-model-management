...
export default function SquareFootageCounter({
  ...
  return (
    <div 
      ref={counterRef}
      className="flex flex-col items-center gap-2 md:gap-1 py-4 md:py-0 w-full md:w-auto"
    >
      ...
      <span className="font-display text-xs md:text-xs tracking-[0.2em] md:tracking-[0.25em] text-[var(--muted)] uppercase text-center">
        {label}
      </span>
    </div>
  );
